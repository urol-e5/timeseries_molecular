---
title: "00.30-D-Ptua-transcriptome-assembly-Trinity"
author: "Sam White"
date: "2026-01-05"
output: 
...
This notebook performs a comprehensive transcriptome assembly and annotaiton for *P.tuahiensis* using the [PASA (Program to Assemble Spliced Alignments)](https://github.com/PASApipeline/PASApipeline/wiki) pipeline, as well as alternative isoform identification. This pipeline relies on both *de novo* and genome-guided transcriptome assemblies with [Trinity](https://github.com/trinityrnaseq/trinityrnaseq/wiki).
...
Trinity was run using the [Trinity Singularity (Apptainer) container](https://github.com/trinityrnaseq/trinityrnaseq/wiki/Trinity-in-Docker#running-trinity-using-singularity), `trinityrnaseq.v2.15.2.simg` from the `urol-e5/timeseries_molecular/F-Ptua/code/` directory.
