...
- <a href="#7-normalized-mirna-counts"
  ...
  - <a href="#71-isolate-normalizedvsd-mirna"
    id="toc-71-isolate-normalizedvsd-mirna">7.1 Isolate normalized/vsd
    miRNA</a>
  ...
  - <a href="#73-normalized-transcript-counts"
    ...
    counts</a>
  - <a href="#74-sample-clustering" id="toc-74-sample-clustering">7.4 Sample
    clustering</a>
  - <a href="#75-heatmap" id="toc-75-heatmap">7.5 Heatmap</a>
- <a href="#8-normalized-sirna-counts"
  id="toc-8-normalized-sirna-counts">8 Normalized siRNA counts</a>
  - <a href="#81-isolate-normalizedvsd-sirna"
    id="toc-81-isolate-normalizedvsd-sirna">8.1 Isolate normalized/vsd
    siRNA</a>
  - <a href="#82-normalized-expression-levels"
    id="toc-82-normalized-expression-levels">8.2 Normalized expression
    levels</a>
  - <a href="#83-normalized-transcript-counts"
    id="toc-83-normalized-transcript-counts">8.3 Normalized transcript
    counts</a>
  - <a href="#84-heatmap" id="toc-84-heatmap">8.4 Heatmap</a>
...
Note that I had to convert the counts to a data frame (instead of a
DESeqTransform object) to select only miRNAs, so I can’t use the
plotPCA() function.
...
![](03.10-D-Apul-sRNAseq-expression-DESeq2_files/figure-gfm/miRNA-clustering-vsd-1.png)<!-- -->
...
![](03.10-D-Apul-sRNAseq-expression-DESeq2_files/figure-gfm/miRNA-clustering-vsd-2.png)<!-- -->
...
![](03.10-D-Apul-sRNAseq-expression-DESeq2_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
...
![](03.10-D-Apul-sRNAseq-expression-DESeq2_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
filter(filtered_results, padj < 0.4)
```

    ##            Name   baseMean log2FoldChange     lfcSE     stat       pvalue
