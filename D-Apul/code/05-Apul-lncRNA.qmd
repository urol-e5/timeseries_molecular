...
wc -l ../output/05-Apul-lncRNA/RNA*.gtf
head ../output/05-Apul-lncRNA/RNA*.gtf
```
...
--merge \
-G ../data/Apulcra-genome.gff \
-o ../output/05-Apul-lncRNA/stringtie_merged.gtf \
../output/05-Apul-lncRNA/RNA*.gtf
```

```{bash}
head /home/shared/8TB_HDD_01/sam/gitrepos/urol-e5/timeseries_molecular/D-Apul/output/02.20-D-Apul-RNAseq-alignment-HiSat2/Apulchra-genome.stringtie.gtf
```

```{r, engine='bash', eval=TRUE}

wc -l /home/shared/8TB_HDD_01/sam/gitrepos/urol-e5/timeseries_molecular/D-Apul/output/02.20-D-Apul-RNAseq-alignment-HiSat2/Apulchra-genome.stringtie.gtf
head /home/shared/8TB_HDD_01/sam/gitrepos/urol-e5/timeseries_molecular/D-Apul/output/02.20-D-Apul-RNAseq-alignment-HiSat2/Apulchra-genome.stringtie.gtf


echo "what is possible"

grep -v '^#' /home/shared/8TB_HDD_01/sam/gitrepos/urol-e5/timeseries_molecular/D-Apul/output/02.20-D-Apul-RNAseq-alignment-HiSat2/Apulchra-genome.stringtie.gtf | cut -f3 | sort | uniq -c
...
```{bash}
ls /home/shared/8TB_HDD_01/sam/gitrepos/urol-e5/timeseries_molecular/D-Apul/data/Apulchra-genome.gff
```

```{r, engine='bash'}
/home/shared/gffcompare-0.12.6.Linux_x86_64/gffcompare \
-r ../data/Apulchra-genome.gff \
-o ../output/05-Apul-lncRNA/gffcompare_merged \
../data/Apulchra-genome.stringtie.gtf
```

```{r, engine='bash', eval=TRUE}
ls ../output/05-Apul-lncRNA/gffcompare_merged*
```

```{r, engine='bash', eval=TRUE}
cat ../output/05-Apul-lncRNA/gffcompare_merged.stats
```

```{r, engine='bash', eval=TRUE}
grep 'class_cod' ../output/05-Apul-lncRNA/gffcompare_merged.annotated.gtf
```
...
```{r, engine='bash'}
awk '$3 == "transcript" && $1 !~ /^#/' \
../output/05-Apul-lncRNA/gffcompare_merged.annotated.gtf | grep 'class_code "u"\|class_code "x"|\class_code "i"\|class_code "y"' | awk '($5 - $4 > 199) || ($4 - $5 > 199)' > ../output/05-Apul-lncRNA/Apul_lncRNA_candidates.gtf
```

```{r, engine='bash', eval=TRUE}
wc -l ../output/05-Apul-lncRNA/Apul_lncRNA_candidates.gtf
head ../output/05-Apul-lncRNA/Apul_lncRNA_candidates.gtf
```
...
-bed ../output/05-Apul-lncRNA/Apul_lncRNA_candidates.gtf \
-fo ../output/05-Apul-lncRNA/Apul_lncRNA_candidates.fasta \
-name -split
```

```{r, engine='bash'}
fgrep -c ">" ../output/05-Apul-lncRNA/Apul_lncRNA_candidates.fasta 
head ../output/05-Apul-lncRNA/Apul_lncRNA_candidates.fasta 
```
...
-i ../output/05-Apul-lncRNA/Apul_lncRNA_candidates.fasta \
-o ../output/05-Apul-lncRNA/Apul_CPC2
```

```{r, engine='bash', eval=TRUE}
wc -l ../output/05-Apul-lncRNA/Apul_CPC2.txt
head ../output/05-Apul-lncRNA/Apul_CPC2.txt
```
...
```{r, engine='bash'}
awk '$8 == "noncoding" {print $1}' ../output/05-Apul-lncRNA/Apul_CPC2.txt > ../output/05-Apul-lncRNA/Apul_noncoding_transcripts_ids.txt
```

```{r, engine='bash'}
wc -l ../output/05-Apul-lncRNA/Apul_noncoding_transcripts_ids.txt
head ../output/05-Apul-lncRNA/Apul_noncoding_transcripts_ids.txt
```
...
```{r, engine='bash'}
/home/shared/samtools-1.12/samtools faidx ../output/05-Apul-lncRNA/Apul_lncRNA_candidates.fasta \
-r ../output/05-Apul-lncRNA/Apul_noncoding_transcripts_ids.txt > ../output/05-Apul-lncRNA/Apul_lncRNA.fasta
...
```{r, engine='bash'}
fgrep -c ">" ../output/05-Apul-lncRNA/Apul_lncRNA.fasta
fgrep ">" ../output/05-Apul-lncRNA/Apul_lncRNA.fasta | head -5

head ../output/05-Apul-lncRNA/Apul_lncRNA.fasta
```
...
with open('../output/05-Apul-lncRNA/Apul_noncoding_transcripts_ids.txt', 'r') as infile, open('../output/05-Apul-lncRNA/Apul_lncRNA.bed', 'w') as outfile:
...
```{r, engine='bash', eval=TRUE}
head ../output/05-Apul-lncRNA/Apul_lncRNA.bed
```
...
RNA-ACR-140 ../output/05-Apul-lncRNA/RNA-ACR-140.gtf RNA-ACR-145 ../output/05-Apul-lncRNA/RNA-ACR-145.gtf RNA-ACR-173 ../output/05-Apul-lncRNA/RNA-ACR-173.gtf RNA-ACR-178 ../output/05-Apul-lncRNA/RNA-ACR-178.gtf

```{r, engine='bash'}
head ../output/05-Apul-lncRNA/list01.txt
```

```{r, engine='bash'}
python /home/shared/stringtie-2.2.1.Linux_x86_64/prepDE.py \
-i ../output/05-Apul-lncRNA/list01.txt \
-g ../output/05-Apul-lncRNA/lnc-gene_count_matrix.csv \
-t ../output/05-Apul-lncRNA/lnc-transcript_count_matrix.csv

head ../output/05-Apul-lncRNA/*matrix.csv
