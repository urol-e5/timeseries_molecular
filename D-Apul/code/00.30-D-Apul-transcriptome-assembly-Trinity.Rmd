...
# CONDA
conda_env_name <- c("/srlab/programs/miniforge3-24.7.1-0")
...
Needed for numpy module in Trinity.
...
`python:         /srlab/programs/miniforge3-24.7.1-0/bin/python`
...
--full_cleanup \
> ${de_novo_output_dir}/trinity.log 2>&1
```
