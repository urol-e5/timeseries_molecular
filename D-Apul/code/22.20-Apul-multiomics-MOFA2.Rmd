...
Since we used MEFISTO to model the time covariate, we can visualize how much of the variation in each factor is explained by the smooth temporal pattern.
...
We can plot the factor values against the continuous time covariate to see how they evolve.

```{r plot-factors-vs-time, eval=TRUE}
# Plot the first few factors against time
plot_factors_vs_covariate(mofa_15, 
  factors = 1:4, 
  covariate = "time",
  color_by = "time_point",
  legend = TRUE
