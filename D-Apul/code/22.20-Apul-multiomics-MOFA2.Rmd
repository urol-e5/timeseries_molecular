...
```{r plot-top-gene-by-miRNA, eval=TRUE}
plot_data_scatter(mofa_objects[["MOFAobject_factors10"]], 
  view = "miRNA",
  factor = 6,  
  features = 12,
...
```{r plot-top-transcript-by-miRNA, eval=TRUE}
plot_data_scatter(mofa_objects[["MOFAobject_factors10"]], 
  view = "miRNA",
  factor = 6,  
  features = 12,
...
```{r plot-top-lncRNA-by-miRNA, eval=TRUE}
plot_data_scatter(mofa_objects[["MOFAobject_factors10"]], 
  view = "miRNA",
  factor = 6,  
  features = 12,
...
```{r plot-miRNA-weights, eval=TRUE}
plot_weights(mofa_objects[["MOFAobject_factors10"]], 
  view = "miRNA", 
  factor = 6, 
  nfeatures = 10
...
```{r plot-top-miRNA-weights, eval=TRUE}
plot_top_weights(mofa_objects[["MOFAobject_factors10"]],
 view = "miRNA",
 factor = 6,
 nfeatures = 10,     # Top number of features to highlight
...
# Print top 10 miRNA features (by absolute weight) and their actual weights for factor 6
weights <- get_weights(mofa_objects[["MOFAobject_factors10"]], view = "miRNA", factor = 6)
...
```{r plot-heatmap-miRNA, eval=TRUE}
plot_data_heatmap(mofa_objects[["MOFAobject_factors10"]], 
  view = "miRNA",
  factor = 6,  
  features = 25,
...
```{r plot-top-miRNA-factor6, eval=TRUE}
# Programmatically get top miRNA by absolute weight for factor 6

# Get top 10 miRNAs by absolute weight for factor 6
weights <- get_weights(mofa_objects[["MOFAobject_factors10"]], view = "miRNA", factor = 6)
weights_vec <- weights[[1]][,1]
names(weights_vec) <- rownames(weights[[1]])
top_n <- 10
...
cat("Top 10 miRNAs by absolute weight for factor 6:\n")
print(top_miRNAs)

# Create a separate plot for each top miRNA
for (miRNA in top_miRNAs) {
  cat("\nPlotting factor 6 colored by miRNA:", miRNA, "\n")
  print(
    plot_factor(mofa_objects[["MOFAobject_factors10"]], 
      factors = 6,
      color_by = miRNA,
...
```{r plot-top-miRNA-by-gene, eval=TRUE}
plot_data_scatter(mofa_objects[["MOFAobject_factors10"]], 
  view = "gene",
  factor = 6,  
  features = 12,
...
```{r plot-top-miRNA-by-transcript, eval=TRUE}
plot_data_scatter(mofa_objects[["MOFAobject_factors10"]], 
  view = "transcript",
  factor = 6,  
  features = 12,
...
```{r plot-top-miRNA-by-lncRNA, eval=TRUE}
plot_data_scatter(mofa_objects[["MOFAobject_factors10"]], 
  view = "lncRNA",
  factor = 6,  
  features = 12,
...
```{r plot-top-miRNA-by-methylation, eval=TRUE}
plot_data_scatter(mofa_objects[["MOFAobject_factors10"]], 
  view = "methylation",
  factor = 6,  
  features = 12,
...
```{r plot-top-methylation-by-miRNA, eval=TRUE}
plot_data_scatter(mofa_objects[["MOFAobject_factors10"]], 
  view = "miRNA",
  factor = 6,  
  features = 12,
