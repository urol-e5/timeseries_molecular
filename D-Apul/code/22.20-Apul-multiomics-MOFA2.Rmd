...
data_files <- list(
  ...
  lncRNA_counts = "../output/31.5-Apul-lncRNA-discovery/lncRNA_counts.clean.filtered.txt",
  miRNA_counts = "../output/10.1-format-miRNA-counts-updated/Apul_miRNA_counts_formatted_updated.txt",
