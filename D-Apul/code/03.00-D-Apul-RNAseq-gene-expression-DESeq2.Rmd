...
tp1.v.tp2.res <- results(dds, contrast=c("condition","TP1","TP2"))
tp1.v.tp3.res <- results(dds, contrast=c("condition","TP1","TP3"))
tp1.v.tp4.res <- results(dds, contrast=c("condition","TP1","TP4"))
tp2.v.tp3.res <- results(dds, contrast=c("condition","TP2","TP3"))
tp2.v.tp4.res <- results(dds, contrast=c("condition","TP2","TP4"))
tp3.v.tp4.res <- results(dds, contrast=c("condition","TP3","TP4"))
