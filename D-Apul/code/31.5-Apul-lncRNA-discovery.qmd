---
title: "31.5-Aupl-lncRNA-discovery"
format: html
editor: visual
---
...
DATA_DIR <- "../data/31.5-Apul-lncRNA-discovery"
OUTPUT_DIR <- "../output/31.5-Apul-lncRNA-discovery"
THREADS <- "48"
...
```{bash}
python ../../M-multi-species/scripts/11-filter_count_matrix.py "${OUTPUT_DIR}/lncRNA_counts.clean.txt" "${OUTPUT_DIR}/lncRNA_counts.clean.filtered.txt"
```
