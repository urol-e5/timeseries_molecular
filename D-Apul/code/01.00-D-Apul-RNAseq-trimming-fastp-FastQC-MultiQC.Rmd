...
echo 'export trimmed_fastqs_dir=${timeseries_dir}/D-Apul/${output_dir_top}/trimmed-fastqs'
echo 'export trimmed_fastqc_dir=${timeseries_dir}/D-Apul/${output_dir_top}/trimmed-fastqc'
echo ""
...
do
  ...
  --out1 "${trimmed_fastqs_dir}"/"${R1_sample_name}".fastp-trim.fq.gz \
  --out2 "${trimmed_fastqs_dir}"/"${R2_sample_name}".fastp-trim.fq.gz
