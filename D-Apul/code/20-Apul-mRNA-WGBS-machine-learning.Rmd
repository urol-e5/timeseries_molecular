...
This script conducts machine learning analyses to predict mRNA state from methylation state.      
...
ggplot(top_cpgs, aes(x = reorder(CpG, abs(Loading)), y = Loading, fill = Methylation_PC)) +
  ...
  labs(title = "Top CpGs Contributing to Most Predictive Methylation PCs",
       x = "CpG Site",
       y = "Loading Strength") +
  facet_wrap(~Methylation_PC, scales = "free_y")  # Separate plots for each PC
