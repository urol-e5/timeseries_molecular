...
1.  Parse `rna_metadata.csv` for *A.pulchra* sample names and time point. This info will be used for downstream file naming and to assign the time point to the read group (`SM:`) in the alignment file.
