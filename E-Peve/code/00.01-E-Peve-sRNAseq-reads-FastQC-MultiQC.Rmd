...
echo ' export timeseries_dir=/gscratch/srlab/kdurkin1/timeseries_molecular'
...
echo 'export fastqc=/srlab/programs/fastqc-0.12.1/fastqc'
...
We have 40 P.evermanni samples (10 colonies, 4 timepoints each), so there should be 80 total sequence files (forward and reverse read for each sample).
