...
pasa_container="pasapipeline.v2.5.3.simg"
PASA_HOME="/usr/local/src/PASApipeline"
stringtie_gtf_dir="../../../output/02.20-E-Peve-RNAseq-alignment-HiSat2"
stringtie_gtf="Porites_evermanni_v1.stringtie.gtf"
...
../output/00.30-E-Peve-transcriptome-assembly-Trinity/de_novo_assembly/apul-denovo-Trinity.fasta \
> ../output/00.30-E-Peve-transcriptome-assembly-Trinity/de_novo_assembly/apul-denovo-Trinity.stats
```
...
-e trinityrnaseq.v2.15.2.simg \
/usr/local/bin/util/TrinityStats.pl \
../output/00.30-E-Peve-transcriptome-assembly-Trinity/genome_guided_assembly/apul-GG-Trinity.fasta \
> ../output/00.30-E-Peve-transcriptome-assembly-Trinity/genome_guided_assembly/apul-GG-Trinity.stats
```
...
-B $PWD/conf.txt:/usr/local/src/PASApipeline/pasa_conf/conf.txt \
-B $PWD/cdna_alignment_mysqlschema:/usr/local/src/PASApipeline/schema/cdna_alignment_mysqlschema \
${pasa_container} \
