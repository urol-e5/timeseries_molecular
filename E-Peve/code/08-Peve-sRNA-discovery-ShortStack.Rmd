...
ShortStack identified 51 miRNAs among all of the P.evermanni samples. This is a notably larger number than the 39 miRNAs identified in `deep-dive-expression`, which examined only 5 colonies from a single time point! I would guess the difference stems from either (a) our capture of more intraspecific diversity, or (b) different miRNA profiles associated with different environmental conditions (i.e. some P.evermanni miRNAs are only expressed under certain conditions). The counts data should give us more insight.
...
ggsave("../output/08-Peve-sRNA-discovery-ShortStack/figures/Peve_ShortStack_miRNA_histogram.png", width = 12, height = 7, units = "in")
...
ggsave("../output/08-Peve-sRNA-discovery-ShortStack/figures/Peve_ShortStack_dbmatch_histogram.png", width = 12, height = 7, units = "in")
```
...
ggsave("../output/08-Peve-sRNA-discovery-ShortStack/figures/Peve_ShortStack_miRNA_histogram_reduced.png", width = 12, height = 7, units = "in")
...
ggsave("../output/08-Peve-sRNA-discovery-ShortStack/figures/Peve_ShortStack_dbmatch_histogram_reduced.png", width = 12, height = 7, units = "in")
```
