...
Filter out CpG sites showing not much of a change in methylation (swamping noise?)
...
ggplot(metab_methylation_res, aes(x = PC1_baseline_metab, y = total_abs_change)) +
