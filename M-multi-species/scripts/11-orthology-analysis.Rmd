...
# Apul database
makeblastdb -in $APUL_PROTEINS -dbtype prot -out ../output/11-orthology-analysis/Apul_proteins -title "Acropora_pulchra_proteins"

# Peve database  
makeblastdb -in $PEVE_PROTEINS -dbtype prot -out ../output/11-orthology-analysis/Peve_proteins -title "Porites_evermanni_proteins"

# Ptua database
makeblastdb -in $PTUA_PROTEINS -dbtype prot -out ../output/11-orthology-analysis/Ptua_proteins -title "Pocillopora_tuahiniensis_proteins"
