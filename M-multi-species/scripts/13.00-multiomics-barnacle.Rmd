...
def calculate_factor_match_score(tensor, decomposition, rank):
    ...
    try:
        ...
        try:
            ...
            print(f"  WARNING: tlviz not available. Installing required dependencies...")
            import subprocess
            import sys
            subprocess.check_call([sys.executable, "-m", "pip", "install", "tensorly-viz"])
            import tlviz.factor_tools
...
if tensor_3d is not None:
    ...
    if len(all_fms_results) > 0:
        ...
        if len(valid_df) > 0:
            ...
            print(f"\nFMS Interpretation:")
            print(f"• Factor Match Score measures how well the decomposition")
            print(f"  captures the underlying tensor structure")
            print(f"• Reconstruction correlation shows tensor reconstruction quality")
            print(f"• Higher scores indicate better factor recovery and model fit")
            print(f"• Consider ranks with consistently high FMS across methods")
