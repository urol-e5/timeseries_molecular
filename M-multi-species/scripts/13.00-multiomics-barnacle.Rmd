...
This section annotates the top 500 genes for components 5, 6, 7, and 9 with GOslim Biological Process terms from the barnacle_factors directory.
...
# Define paths
barnacle_factors_dir <- file.path(output_dir, "barnacle_factors")
goslim_output_dir <- file.path(output_dir, "barnacle_factors", "goslim_analysis")
...
cat(strrep("=", 60), "\n\n")
cat("Barnacle factors directory:", barnacle_factors_dir, "\n")
...
for (comp_num in components_to_analyze) {
  file_path <- file.path(barnacle_factors_dir, 
...
for (comp_num in components_to_analyze) {
  ...
  p <- ggplot(top_goslim, aes(x = goslim_name, y = count)) +
    ...
    labs(
      ...
      subtitle = paste0("From top 500 genes (ranked by absolute loading)"),
...
cat("  - component_[5,6,7,9]_goslim_BP_barchart.png\n")
