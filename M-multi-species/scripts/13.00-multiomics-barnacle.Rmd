...
# Save sample mapping (contains all species info)
sample_mapping.to_csv(sample_mapping_file, index=False)
print(f"✓ Sample mapping saved: {sample_mapping_file}")
print(f"  (species_sample_map can be reconstructed from this CSV)")
...
# Reconstruct species_sample_map dictionary from sample_mapping DataFrame
species_sample_map = {}
for _, row in sample_mapping.iterrows():
    species_sample_map[int(row['combined_index'])] = {
        'species': row['species'],
        'sample_id': row['sample_id']
    }
print(f"✓ Reconstructed species sample map from CSV")
