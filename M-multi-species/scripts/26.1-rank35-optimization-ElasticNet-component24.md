26.1-rank35-optimization-ElasticNet-component24
================
Kathleen Durkin
2025-11-11
...
- [5 A. pulchra](#5-a-pulchra)
  - [5.1 Load and format data](#51-load-and-format-data)
    ...
    - [5.1.3 Merge predictor features](#513-merge-predictor-features)
    - [5.1.4 Format](#514-format)
...
- [6 P. evermanni](#6-p-evermanni)
  - [6.1 Load and format data](#61-load-and-format-data)
    ...
    - [6.1.3 Merge predictor features](#613-merge-predictor-features)
    - [6.1.4 Format](#614-format)
...
- [7 P. tuahiniensis](#7-p-tuahiniensis)
  - [7.1 Load and format data](#71-load-and-format-data)
    ...
    - [7.1.3 Merge predictor features](#713-merge-predictor-features)
    - [7.1.4 Format](#714-format)
...
get_feature_importance <- function(models) {
  importance_list <- lapply(models, function(model) {
    coefs <- as.matrix(coef(model, s = "lambda.1se"))[-1, , drop = FALSE]  # Convert to regular matrix & remove intercept
...
evaluate_model_performance <- function(models, response_features, predictor_features) {
  ...
  for (feature in colnames(response_features)) {
    ...
    preds <- predict(model, X, s = "lambda.1se")
...
train_models_split <- function(response_features, predictor_features, train_frac = 0.8, alpha = 0.5, nfolds = 10) {
  ...
  for (feature in colnames(response_features)) {
    ...
    preds <- predict(model, newx = as.matrix(X_test), s = "lambda.1se")
...
Also must round WGBS data to whole integers for normalization - need to
...
### 5.1.3 Merge predictor features
...
```
    ...
    ##    <chr>        <dbl>  <dbl>   <dbl>           <int>
    ##  1 FUN_000398   0.846 0.106  0.0336               10
    ##  2 FUN_001472   0.925 0.0353 0.0111               10
    ##  3 FUN_001503   0.847 0.0862 0.0273               10
    ##  4 FUN_001545   0.959 0.0298 0.00943              10
    ##  5 FUN_001628   0.836 0.0879 0.0278               10
    ##  6 FUN_004740   0.791 0.153  0.0484               10
    ##  7 FUN_007645   0.876 0.0588 0.0186               10
    ##  8 FUN_007914   0.900 0.0584 0.0185               10
    ##  9 FUN_008245   0.828 0.103  0.0325               10
    ## 10 FUN_008515   0.817 0.116  0.0368               10
    ## # ℹ 90 more rows
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
Of the original 100 genes selected from component 24, 75 are
...
```
    ...
    ##    Feature    Mean_R2  SD_R2  SE_R2 High_Perf_Count
    ##    <chr>        <dbl>  <dbl>  <dbl>           <int>
    ##  1 FUN_001472   0.880 0.0736 0.0147              25
    ##  2 FUN_001545   0.939 0.0521 0.0104              25
    ##  3 FUN_008245   0.804 0.141  0.0281              25
    ##  4 FUN_008515   0.776 0.107  0.0214              25
    ##  5 FUN_016049   0.887 0.0726 0.0145              25
    ##  6 FUN_023551   0.802 0.122  0.0245              25
    ##  7 FUN_026486   0.831 0.0846 0.0169              25
    ##  8 FUN_035821   0.810 0.106  0.0211              25
    ##  9 FUN_040328   0.814 0.0863 0.0173              25
    ## 10 FUN_040987   0.851 0.105  0.0210              25
    ## # ℹ 65 more rows
...
When I train the model on only these 75 well-predicted genes, 68 of them
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-31-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-33-1.png)<!-- -->
...
get_feature_importance_for_feature <- function(model) {
  coefs <- as.matrix(coef(model, s = "lambda.1se"))[-1, , drop = FALSE]  # remove intercept
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-2.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-3.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-4.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-5.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-6.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-7.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-8.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-9.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-10.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-11.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-12.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-13.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-14.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-15.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-16.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-17.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-18.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-19.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-20.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-21.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-22.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-23.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-24.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-25.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-26.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-27.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-28.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-29.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-30.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-31.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-32.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-33.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-34.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-35.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-36.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-37.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-38.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-39.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-40.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-41.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-42.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-43.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-44.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-45.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-46.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-47.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-48.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-49.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-50.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-51.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-52.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-53.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-54.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-55.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-56.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-57.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-58.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-59.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-60.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-61.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-62.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-63.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-64.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-65.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-66.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-67.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-34-68.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-1.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-2.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-3.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-4.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-5.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-6.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-7.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-8.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-9.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-10.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-11.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-12.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-13.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-14.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-15.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-16.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-17.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-18.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-19.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-20.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-21.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-22.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-23.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-24.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-25.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-26.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-27.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-28.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-29.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-30.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-31.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-32.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-33.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-34.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-35.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-36.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-37.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-38.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-39.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-40.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-41.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-42.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-43.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-44.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-45.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-46.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-47.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-48.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-49.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-50.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-51.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-52.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-53.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-54.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-55.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-56.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-57.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-58.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-59.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-60.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-61.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-62.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-63.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-64.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-65.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-66.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-67.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-35-68.png)<!-- -->
...
```
    ...
    ##    <chr>                            <dbl> <chr>  <chr>     
    ##  1 CpG_ptg000008l_27992749         0.135  CpG    FUN_000398
    ##  2 lncRNA_13423                    0.0648 lncRNA FUN_000398
    ##  3 CpG_ptg000002l_5531047          0.0625 CpG    FUN_000398
    ##  4 lncRNA_19946                    0.0523 lncRNA FUN_000398
    ##  5 CpG_ntLink_8_12175046           0.0521 CpG    FUN_000398
    ##  6 lncRNA_30058                    0.0443 lncRNA FUN_000398
    ##  7 lncRNA_910                      0.0392 lncRNA FUN_000398
    ##  8 lncRNA_909                      0.0382 lncRNA FUN_000398
    ##  9 lncRNA_14636                    0.0379 lncRNA FUN_000398
    ## 10 lncRNA_19947                    0.0360 lncRNA FUN_000398
    ## # ℹ 1,350 more rows
...
This is throwing an error: “Error in
...
To avoid having excessive 0 values that interfere with geometric mean
calculations, I’m going to add a pseudo-count of 1 to all counts. This
is a simple workaround, but I should revisit later to determine whether
its appropriate or I need to do a more in-depth fix.
...
### 6.1.3 Merge predictor features
...
```
    ...
    ##    Feature            Mean_R2  SD_R2  SE_R2 High_Perf_Count
    ##    <chr>                <dbl>  <dbl>  <dbl>           <int>
    ##  1 gene-Peve_00002553   0.924 0.0407 0.0129              10
    ##  2 gene-Peve_00007763   0.799 0.129  0.0408              10
    ##  3 gene-Peve_00008524   0.864 0.118  0.0372              10
    ##  4 gene-Peve_00032197   0.908 0.0594 0.0188              10
    ##  5 gene-Peve_00010478   0.774 0.262  0.0830               9
    ##  6 gene-Peve_00018856   0.875 0.194  0.0614               9
    ##  7 gene-Peve_00025748   0.659 0.229  0.0726               9
    ##  8 gene-Peve_00030694   0.832 0.261  0.0827               9
    ##  9 gene-Peve_00040540   0.677 0.137  0.0432               9
    ## 10 gene-Peve_00025427   0.603 0.129  0.0408               8
    ## # ℹ 90 more rows
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-55-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-56-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-57-1.png)<!-- -->
...
Of the original 100 genes selected from component 24, 29 are
consistently well-predicted by our model (mean R^2 \> 0.5, over 10
replicates).
...
```
    ...
    ##    Feature            Mean_R2  SD_R2  SE_R2 High_Perf_Count
    ##    <chr>                <dbl>  <dbl>  <dbl>           <int>
    ##  1 gene-Peve_00002553   0.907 0.0905 0.0181              25
    ##  2 gene-Peve_00018856   0.891 0.0763 0.0153              25
    ##  3 gene-Peve_00030694   0.914 0.0603 0.0121              25
    ##  4 gene-Peve_00032197   0.872 0.0935 0.0187              25
    ##  5 gene-Peve_00007763   0.809 0.134  0.0268              24
    ##  6 gene-Peve_00008524   0.889 0.105  0.0210              24
    ##  7 gene-Peve_00010478   0.841 0.124  0.0248              24
    ##  8 gene-Peve_00009929   0.787 0.171  0.0341              23
    ##  9 gene-Peve_00021488   0.736 0.164  0.0327              23
    ## 10 gene-Peve_00023595   0.734 0.143  0.0286              23
    ## # ℹ 19 more rows
...
When I train the model on only these 29 well-predicted genes, 25 of them
are again well-predicted. That’s a much higher success rate! This
suggests that epigenetic mechanisms may indeed be able to predict
expression of these genes
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-62-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-63-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-64-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-1.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-2.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-3.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-4.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-5.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-6.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-7.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-8.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-9.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-10.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-11.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-12.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-13.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-14.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-15.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-16.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-17.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-18.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-19.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-20.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-21.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-22.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-23.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-24.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-65-25.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-1.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-2.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-3.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-4.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-5.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-6.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-7.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-8.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-9.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-10.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-11.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-12.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-13.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-14.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-15.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-16.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-17.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-18.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-19.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-20.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-21.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-22.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-23.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-24.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-66-25.png)<!-- -->
...
```
    ...
    ##    Predictor                                MeanImportance Type  Feature        
    ##    <chr>                                             <dbl> <chr> <chr>          
    ##  1 CpG_Porites_evermani_scaffold_1469_73554         0.273  CpG   gene-Peve_0000…
    ##  2 CpG_Porites_evermani_scaffold_844_127021         0.253  CpG   gene-Peve_0000…
    ##  3 CpG_Porites_evermani_scaffold_4081_16088         0.175  CpG   gene-Peve_0000…
    ##  4 CpG_Porites_evermani_scaffold_564_108893         0.158  CpG   gene-Peve_0000…
    ##  5 CpG_Porites_evermani_scaffold_7_1005867          0.135  CpG   gene-Peve_0000…
    ##  6 CpG_Porites_evermani_scaffold_8154_1223          0.134  CpG   gene-Peve_0000…
    ##  7 CpG_Porites_evermani_scaffold_90_370073          0.126  CpG   gene-Peve_0000…
    ##  8 CpG_Porites_evermani_scaffold_2111_2377          0.0912 CpG   gene-Peve_0000…
    ##  9 CpG_Porites_evermani_scaffold_2365_63156         0.0756 CpG   gene-Peve_0000…
    ## 10 CpG_Porites_evermani_scaffold_830_4325           0.0736 CpG   gene-Peve_0000…
    ## # ℹ 490 more rows
...
### 7.1.3 Merge predictor features
...
Hitting a caching issue when running initial bootstrapping n=10, so
decreasing to n=5 for now
...
```
    ...
    ##    Feature                                 Mean_R2  SD_R2  SE_R2 High_Perf_Count
    ##    <chr>                                     <dbl>  <dbl>  <dbl>           <int>
    ##  1 gene-Pocillopora_meandrina_HIv1___RNAs…   0.816 0.0908 0.0406               5
    ##  2 gene-Pocillopora_meandrina_HIv1___RNAs…   0.852 0.0950 0.0425               5
    ##  3 gene-Pocillopora_meandrina_HIv1___RNAs…   0.859 0.0565 0.0253               5
    ##  4 gene-Pocillopora_meandrina_HIv1___RNAs…   0.836 0.0266 0.0119               5
    ##  5 gene-Pocillopora_meandrina_HIv1___RNAs…   0.759 0.193  0.0864               5
    ##  6 gene-Pocillopora_meandrina_HIv1___RNAs…   0.734 0.143  0.0638               5
    ##  7 gene-Pocillopora_meandrina_HIv1___RNAs…   0.886 0.0895 0.0400               5
    ##  8 gene-Pocillopora_meandrina_HIv1___RNAs…   0.841 0.0532 0.0238               5
    ##  9 gene-Pocillopora_meandrina_HIv1___RNAs…   0.800 0.0680 0.0304               5
    ## 10 gene-Pocillopora_meandrina_HIv1___RNAs…   0.841 0.120  0.0539               5
    ## # ℹ 90 more rows
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-86-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-87-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-88-1.png)<!-- -->
...
Of the original 100 genes selected from component 24, 30 are
consistently well-predicted by our model (mean R^2 \> 0.5, over 5
replicates).
...
```
    ...
    ##    Feature                                 Mean_R2  SD_R2  SE_R2 High_Perf_Count
    ##    <chr>                                     <dbl>  <dbl>  <dbl>           <int>
    ##  1 gene-Pocillopora_meandrina_HIv1___RNAs…   0.858 0.0695 0.0220              10
    ##  2 gene-Pocillopora_meandrina_HIv1___RNAs…   0.792 0.0946 0.0299              10
    ##  3 gene-Pocillopora_meandrina_HIv1___RNAs…   0.786 0.119  0.0376              10
    ##  4 gene-Pocillopora_meandrina_HIv1___RNAs…   0.831 0.111  0.0351              10
    ##  5 gene-Pocillopora_meandrina_HIv1___RNAs…   0.758 0.130  0.0410              10
    ##  6 gene-Pocillopora_meandrina_HIv1___RNAs…   0.841 0.108  0.0343              10
    ##  7 gene-Pocillopora_meandrina_HIv1___RNAs…   0.764 0.254  0.0804               9
    ##  8 gene-Pocillopora_meandrina_HIv1___RNAs…   0.697 0.188  0.0594               9
    ##  9 gene-Pocillopora_meandrina_HIv1___RNAs…   0.833 0.208  0.0658               9
    ## 10 gene-Pocillopora_meandrina_HIv1___RNAs…   0.773 0.203  0.0643               9
    ## # ℹ 20 more rows
...
When I train the model on only these 20 well-predicted genes, 25 of them
are again well-predicted. That’s a much higher success rate! This
suggests that epigenetic mechanisms may indeed be able to predict
expression of these genes
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-93-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-94-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-95-1.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-1.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-2.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-3.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-4.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-5.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-6.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-7.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-8.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-9.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-10.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-11.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-12.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-13.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-14.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-15.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-16.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-17.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-18.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-19.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-20.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-21.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-22.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-23.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-24.png)<!-- -->![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-96-25.png)<!-- -->
...
![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-1.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-2.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-3.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-4.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-5.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-6.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-7.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-8.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-9.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-10.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-11.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-12.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-13.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-14.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-15.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-16.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-17.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-18.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-19.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-20.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-21.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-22.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-23.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-24.png)<!-- -->

    ## `geom_smooth()` using formula = 'y ~ x'

![](26.1-rank35-optimization-ElasticNet-component24_files/figure-gfm/unnamed-chunk-97-25.png)<!-- -->
...
```
    ...
    ##    Predictor                                        MeanImportance Type  Feature
    ##    <chr>                                                     <dbl> <chr> <chr>  
    ##  1 CpG_Pocillopora_meandrina_HIv1___Sc0000020_6545…         0.0866 CpG   gene-P…
    ##  2 lncRNA_29175                                             0.0734 lncR… gene-P…
    ##  3 CpG_Pocillopora_meandrina_HIv1___Sc0000002_1290…         0.0558 CpG   gene-P…
    ##  4 CpG_Pocillopora_meandrina_HIv1___Sc0000011_1126…         0.0431 CpG   gene-P…
    ##  5 lncRNA_15690                                             0.0361 lncR… gene-P…
    ##  6 CpG_Pocillopora_meandrina_HIv1___Sc0000001_1443…         0.0327 CpG   gene-P…
    ##  7 lncRNA_29016                                             0.0239 lncR… gene-P…
    ##  8 CpG_Pocillopora_meandrina_HIv1___Sc0000000_1914…         0.0227 CpG   gene-P…
    ##  9 CpG_Pocillopora_meandrina_HIv1___Sc0000000_1914…         0.0207 CpG   gene-P…
    ## 10 lncRNA_20723                                             0.0207 lncR… gene-P…
    ## # ℹ 490 more rows

``` r
# Optional: save to CSV
write.csv(Ptuh_top_predictors_df, "../output/26.1-rank35-optemization-ElasticNet-component24/Ptuh_top_predictors.csv", row.names = FALSE)
```
