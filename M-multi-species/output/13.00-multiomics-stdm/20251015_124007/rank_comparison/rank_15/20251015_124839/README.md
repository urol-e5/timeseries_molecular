...
- **Timestamp**: 2025-10-15 12:49:22
- **Input File**: ../output/13.00-multiomics-stdm/vst_counts_matrix_long_format.csv
- **Output Directory**: ../output/13.00-multiomics-stdm/20251015_124007/rank_comparison/rank_15/20251015_124839
- **Method**: PARAFAC
- **Rank**: 15
...
- **Reconstruction Error**: 0.361271
- **Quality Assessment**: Acceptable
- **Gene Factors Shape**: (9800, 15)
- **Species Factors Shape**: (30, 15)
- **Time Factors Shape**: (4, 15)
...
### 1. **gene_factors.npy**
- **Description**: Gene factor matrix (9,800 × 15)
...
- **Description**: Species factor matrix (30 × 15)
...
### 3. **time_factors.npy**
- **Description**: Time point factor matrix (4 × 15)
...
**Reconstruction Error**: 0.361271 (Acceptable)
...
**Rank Selection**: Current rank (15) appears appropriate
