...
- **Timestamp**: 2025-10-15 12:47:57
- **Input File**: ../output/13.00-multiomics-stdm/vst_counts_matrix_long_format.csv
- **Output Directory**: ../output/13.00-multiomics-stdm/20251015_124007/rank_comparison/rank_13/20251015_124715
- **Method**: PARAFAC
- **Rank**: 13
...
- **Reconstruction Error**: 0.372614
- **Quality Assessment**: Acceptable
- **Gene Factors Shape**: (9800, 13)
- **Species Factors Shape**: (30, 13)
- **Time Factors Shape**: (4, 13)
...
### 1. **gene_factors.npy**
- **Description**: Gene factor matrix (9,800 × 13)
...
- **Description**: Species factor matrix (30 × 13)
...
### 3. **time_factors.npy**
- **Description**: Time point factor matrix (4 × 13)
...
**Reconstruction Error**: 0.372614 (Acceptable)
...
**Rank Selection**: Current rank (13) appears appropriate
