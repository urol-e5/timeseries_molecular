...
- **Timestamp**: 2025-10-15 12:42:00
- **Input File**: ../output/13.00-multiomics-stdm/vst_counts_matrix_long_format.csv
- **Output Directory**: ../output/13.00-multiomics-stdm/20251015_124007/rank_comparison/rank_04/20251015_124122
- **Method**: PARAFAC
- **Rank**: 4
...
- **Reconstruction Error**: 0.470066
- **Quality Assessment**: Acceptable
- **Gene Factors Shape**: (9800, 4)
- **Species Factors Shape**: (30, 4)
...
### 1. **gene_factors.npy**
- **Description**: Gene factor matrix (9,800 × 4)
...
- **Description**: Species factor matrix (30 × 4)
...
### 3. **time_factors.npy**
- **Description**: Time point factor matrix (4 × 4)
...
**Reconstruction Error**: 0.470066 (Acceptable)
...
**Rank Selection**: Current rank (4) appears appropriate
