...
- **Timestamp**: 2025-10-15 12:43:17
- **Input File**: ../output/13.00-multiomics-stdm/vst_counts_matrix_long_format.csv
- **Output Directory**: ../output/13.00-multiomics-stdm/20251015_124007/rank_comparison/rank_06/20251015_124238
- **Method**: PARAFAC
- **Rank**: 6
...
- **Reconstruction Error**: 0.439105
- **Quality Assessment**: Acceptable
- **Gene Factors Shape**: (9800, 6)
- **Species Factors Shape**: (30, 6)
- **Time Factors Shape**: (4, 6)
...
### 1. **gene_factors.npy**
- **Description**: Gene factor matrix (9,800 × 6)
...
- **Description**: Species factor matrix (30 × 6)
...
### 3. **time_factors.npy**
- **Description**: Time point factor matrix (4 × 6)
...
**Reconstruction Error**: 0.439105 (Acceptable)
...
**Rank Selection**: Current rank (6) appears appropriate
