...
- **Timestamp**: 2025-10-15 12:27:25
- **Input File**: ../output/13.00-multiomics-stdm/vst_counts_matrix_long_format.csv
- **Output Directory**: ../output/13.00-multiomics-stdm/20251015_122334/rank_comparison/rank_07/20251015_122647
- **Method**: PARAFAC
- **Rank**: 7
...
- **Reconstruction Error**: 0.428435
- **Quality Assessment**: Acceptable
- **Gene Factors Shape**: (9800, 7)
- **Species Factors Shape**: (30, 7)
- **Time Factors Shape**: (4, 7)
...
### 1. **gene_factors.npy**
- **Description**: Gene factor matrix (9,800 × 7)
...
- **Description**: Species factor matrix (30 × 7)
...
### 3. **time_factors.npy**
- **Description**: Time point factor matrix (4 × 7)
...
**Reconstruction Error**: 0.428435 (Acceptable)
...
**Rank Selection**: Current rank (7) appears appropriate
