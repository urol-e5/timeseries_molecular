...
- **Timestamp**: 2025-10-15 12:24:52
- **Input File**: ../output/13.00-multiomics-stdm/vst_counts_matrix_long_format.csv
- **Output Directory**: ../output/13.00-multiomics-stdm/20251015_122334/rank_comparison/rank_03/20251015_122414
- **Method**: PARAFAC
- **Rank**: 3
...
- **Reconstruction Error**: 0.549230
- **Quality Assessment**: Poor
- **Gene Factors Shape**: (9800, 3)
- **Species Factors Shape**: (30, 3)
- **Time Factors Shape**: (4, 3)
...
### 1. **gene_factors.npy**
- **Description**: Gene factor matrix (9,800 × 3)
...
- **Description**: Species factor matrix (30 × 3)
...
### 3. **time_factors.npy**
- **Description**: Time point factor matrix (4 × 3)
...
**Reconstruction Error**: 0.549230 (Poor)
...
**Rank Selection**: Try increasing rank to 8 or 13
