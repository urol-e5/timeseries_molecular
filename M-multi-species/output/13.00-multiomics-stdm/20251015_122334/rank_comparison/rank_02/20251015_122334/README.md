...
- **Timestamp**: 2025-10-15 12:24:13
- **Input File**: ../output/13.00-multiomics-stdm/vst_counts_matrix_long_format.csv
- **Output Directory**: ../output/13.00-multiomics-stdm/20251015_122334/rank_comparison/rank_02/20251015_122334
- **Method**: PARAFAC
- **Rank**: 2
...
- **Reconstruction Error**: 0.615404
- **Quality Assessment**: Poor
- **Gene Factors Shape**: (9800, 2)
- **Species Factors Shape**: (30, 2)
- **Time Factors Shape**: (4, 2)
...
### 1. **gene_factors.npy**
- **Description**: Gene factor matrix (9,800 × 2)
...
- **Description**: Species factor matrix (30 × 2)
...
### 3. **time_factors.npy**
- **Description**: Time point factor matrix (4 × 2)
...
**Reconstruction Error**: 0.615404 (Poor)
...
**Rank Selection**: Try increasing rank to 7 or 12
